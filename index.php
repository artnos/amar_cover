...
#home #heroSlider .item .left-copy {
    font-size:20px;
width: 230px;
}
...
<div class="right">
 ...
 <ul class="panel-group" id="main-nav">
...
<!-- <ul>
	...
	<li class="small"><a href="#">option a</a></li>
	<li class="small"><a href="#">option b</a></li>
	<li class="small"><a href="#">option c</a></li>
</ul> -->
               

             
 <ul class="panel-group" id="social-nav">
		 		...
		 		<li><a href="https://www.linkedin.com/company-beta/5940516/?pathWildcard=5940516" class=" small "> Linkedin </a></li>
		
	
	
			             
			
		 		<li><a href="https://twitter.com/AmaranthMedical" class=" small "> Twitter </a></li>
   ...
   <div id="search-window">
          <div>
             ...
             <form id="search-form" action="" class="Search-form">
                    <input class="Search-input" type="search" name="q" autocomplete="off" placeholder="Search Amaranth">
             </form>
                     <div id="count"></div>
                     <div id="output"></div>
                     <div id="more"></div>
...
<main id="main">
            <div id="heroSlider" class="carousel slide active0" data-ride="carousel" data-pause="hover" data-interval="12000" style="max-width: 1400px;
    margin: 0 auto;">
  <!-- Indicators -->
  ...
  <div class="carousel-inner" role="listbox">
      <div class="item active">
          <img src="img/slider0.jpg" class="img-responsive" alt="">
      </div>
    <div class="item">
    	<img src="img/AmaranthSlider.jpg" class="img-responsive" alt="">
    </div>
  <div class="item ">
  	<img src="img/slide1B.jpg" class="img-responsive" alt="">
  	<div class="copy-gray">
  		<div> 
  		<span>The Amaranth Advantage: </span>
            <span>World’s First Sub-100 µm</span>
            <span>with Metal-like Performance. </span>
            <span>Thin. Strong. Flexible.</span>
		</div>
   ...
   <div class="item">
   	<img src="img/slide4B.jpg" class="img-responsive" alt="">
   	<!-- left-copy -->
   	<div class="copy-gray">
   		<div>
<span>Amaranth’s Pace-setting </span>
<span>Technology Continues to </span>
<span>Demonstrate Safety and </span>
<span>Viability of BRS.</span>
   ...
   <div class="item">
   <img src="img/slide6B.jpg" class="img-responsive" alt="">
   	<div class="copy-gray">
   		<div>
              <span>Amaranth is dedicated </span>
              <span>to Becoming the </span>
              <span>First Choice for Patients </span>
              <span>Around the Globe </span>
            </div>
   	</div>
   </div>
<!--
   <div class="item  euro hide-on-mobile" >
   <img src="img/EuroPCR6.jpg" class="hidden-xs img-responsive" alt="">
      <img src="img/EuroPCR6-blank.jpg" class="visible-xs img-responsive" alt="">
      <div class="copy visible-xs ">
        Come see us at euroPCR
      </div>
</div>
-->
<!--    <div class="item" >
  ...
  <a class="left carousel-control" href="#heroSlider" role="button" data-slide="prev">
		<i class="fa fa-angle-left" aria-hidden="true"></i>

    </a>
    <a class="right carousel-control" href="#heroSlider" role="button" data-slide="next">
...
<div id="euro" style="display:none">
      ...
      <div class="copy">
                 <div>
                <div class="row">
                 <img class="left" src="img/euro-left-black.png" alt="">
                  <img class="right" src="img/euro-right-black.png" alt="">
                </div>
                  <h4>Tuesday, May 16, 2017, <br>12:00 noon-1:30 PM, Room 351</h4>
                 <strong>Evolving BRS technology</strong>
                <p>Chairpersons: E. Edelman , Y. Onuma<br>
                       </p><table>
                         <tbody><tr>
                           <td><strong class="time">12:15 PM -</strong></td>
                           <td>Nine-month clinical and imaging outcomes of a novel&nbsp;ultra-high molecular weight poly-L-lactide BRS. 
                               A prospective multicenter&nbsp;international investigation: The RENASCENT II study, <span class="name">A. Colombo</span></td>
                         </tr>
                       </tbody></table>
                <p></p>

                <h4>Wednesday May 17,&nbsp;2017<br> 4:30-6:00 PM, Room 351</h4>
                <strong>Design Considerations and clinical experience of a novel thin-walled 
                  high-performance bioresorbable coronary scaffold</strong>
                <em>Sponsored by Amaranth Medical</em>
                <p>Chairpersons: A. Colombo and G.W. Stone<br>
                      </p><table>
                        <tbody><tr>
                          <td><strong class="time">4:35 PM - </strong></td>
                          <td>The future of BRS technologies: techtnical lessons learned from the Absorb BVS programme, <span class="name">G.W. Stone</span></td>
                        </tr>
                        <tr>
                          <td> <strong class="time">4:55 PM - </strong></td>
                          <td>The Amaranth Medical BRS: development of a thin-walled novel poly-L-lactade-based polymeric BRS,<span class="name"> J. Granada</span></td>
                        </tr>
                        <tr>
                          <td><strong class="time">5:15 PM - </strong></td>
                          <td>Clinical update: from FORTITUDE<sup>®</sup> 150 µm to APTITUDE<sup>®</sup> 115 µm, <span class="name">G. Esposito</span></td>
                        </tr>
                        <tr>
                          <td><strong class="time">5:35 PM - </strong></td>
                          <td>Technology pipeline: the MAGNITUDE<sup>®</sup> sub-100 µm BRS programme, <span class="name">A. Colombo</span></td>
                        </tr>
                      </tbody></table>
...
<h2>Amaranth Medical In The News</h2>
<hr>
...
<div class="clearfix"></div>
            ...
            <div class="clearfix"></div>
            <section id="sitemap">              
                <div class="content"><h3>Sitemap</h3> </div>        
                <hr>
...
<div class="row">
		...
		<li class="level1"><a href="contact">Contact Amaranth</a></li>
            ...
            <footer>        
            <div class="content"><p>
<sup><a href="#_ftnref1" name="_ftn1">1</a></sup> Amaranth’s bioresorbable scaffolds are investigational devices and not currently available for sale or marketing. 

</p>  </div>
               <img src="img/logo-mobile.png" alt=""> Copyright © 2017 Amaranth Medical, Inc. All rights reserved
